            ...
            <body>
                <div class="container">
                    <div class="row justify-content-center">
                        <form action="/api/update_films/{{ $films->id }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                    
                            <div class="col-md-12">
                                <label for="Nama_Films">Nama Films</label>
                                <input type="text" name="nama_films" id="nama_films" class="form-control" value="{{ $films->nama_films}}">
                            </div>
